...
import es.iespuertodelacruz.mp.canarytrails.controller.v2.FaunaControllerV2;
...
//test admin
@WebMvcTest(FaunaControllerV2.class)
...
public class FaunaControllerV2Test {
    ...
    public void findAllFaunasTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/faunas"))
    ...
    public void findFaunaByIdTest_NotFound() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/faunas/99"))
    ...
    public void updateFaunaTest() throws Exception {
        ...
        mockMvc.perform(put("/api/v2/faunas/update")
    ...
    public void uploadFileTest() throws Exception {
        ...
        mockMvc.perform(multipart("/api/v2/faunas/upload/{id}", 1)
                        .file(file)
                        .param("id", "1"))
                .andExpect(status().isOk())
    ...
    public void createFaunaTest() throws Exception {
        ...
        mockMvc.perform(post("/api/v2/faunas/add")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void shouldReturnFaunaById() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/faunas/1")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
